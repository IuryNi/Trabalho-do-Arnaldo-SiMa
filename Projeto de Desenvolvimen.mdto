...
| :--- | :---: | :---: | :---: | :---: | ---: |
| 15/12/2025 | Tela de Login e Retirar Livro | - | - | 33 | 20/12/2025 |
...
Daily meetings (reuniões rápidas diárias) para alinhamento.  

Sprints semanais, conforme o cronograma apresentado.  

Revisões de sprint para apresentação do que foi desenvolvido.  

Retrospectivas para ajustes no processo.  

As tarefas serão organizadas no GitHub Projects, permitindo visualização de progresso. Serão definidos critérios de aceitação claros para cada tarefa, e métricas de qualidade do código serão monitoradas, incluindo cobertura mínima de testes e aprovação obrigatória em code review.  
...
Planejamento da tarefa (PO + Dev Pleno)  

Criação da branch no Git seguindo o padrão:  
feature/nome-da-funcionalidade  

Desenvolvimento da funcionalidade  

Commit e versionamento semântico  

Pull Request para revisão do Dev Pleno  

Code Review obrigatório pelos desenvolvedores  
...
Merge para branch principal após aprovação  

Deploy automático realizado pelo DevOps  
...
A documentação da API será feita em Swagger  

Procedimentos internos, definições de tarefas e orientações técnicas serão mantidos em Markdown dentro do repositório  

Instruções de setup, build e contribuições estarão no README principal  

Serão mantidos registros de decisões técnicas (decision logs) e documentação de processos para referência futura.  

 

7. Manutenção Pós-Lançamento  
...
Estimativa Mensal em Reais (R$) 

Observação 

Servidor Backend e API 

100 a 300 

Hospedagem do backend do aplicativo 
...
Incluído na infraestrutura fornecida pelo Centro Paula Souza 

Pipelines de Integração Contínua (GitHub Actions) 
...
Os valores apresentados acima representam o custo do desenvolvimento caso fossem necessários recursos externos, em um projeto privado. Como se trata de um projeto público, a maior parte da infraestrutura, domínio institucional e operação já é fornecida pelo Centro Paula Souza, reduzindo significativamente o gasto direto. 
